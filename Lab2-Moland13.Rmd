...
tbl_2way %>% 
    ...
    tab_header(
        ...
        subtitle = "Total CPUE by Region and Year",
    ) |>
    cols_label(
        bol = "Bolærne",
        flo = "Kvernskjær",
...
tbl_3way %>%
    ...
    cols_label(bol_con = "Control",
               ...
               kve_con = "Control",
               kve_mpa = "MPA") |>
    data_color(columns = c("bol_con", "flo_con", "kve_con"),
               colors = scales::col_numeric(palette = c("skyblue4"),domain = NULL)) %>%
    data_color(columns = c("bol_mpa", "flo_mpa", "kve_mpa"),
               colors = scales::col_numeric(palette = c("seagreen"), domain = NULL))
